...
//        uint256 amount
//    ) internal {
//        _paymentsToBeReviewed[paymentIdHash] = BS.FlagedPaymentRecord(_approvedBorrower, amount);
//        emit PaymentFlaggedForReview(paymentIdHash, _approvedBorrower, amount);
//    }
//
...
//            receivableParam
//        );
//        _receivableInfoMapping[_approvedBorrower] = ri;
//    }
//
//    /**
...
//        BS.ReceivableInfo memory ri = _receivableInfoMapping[_approvedBorrower];
//
...
//
//            IERC721(receivableAsset).safeTransferFrom(_approvedBorrower, address(this), receivableParam);
//        } else {
//            // This has to be ERC20
//            if (receivableParam < ri.receivableParam) revert Errors.insufficientReceivableAmount();
//
//            IERC20(receivableAsset).safeTransferFrom(_approvedBorrower, address(this), receivableParam);
//        }
//    }
//
//    /**
...
//        assert(_receivableInfoMapping[_approvedBorrower].receivableAsset != address(0));
//        _checkReceivableRequirement(
//            newCreditLimit,
//            _receivableInfoMapping[_approvedBorrower].receivableAmount
//        );
//    }
//
//    /**
