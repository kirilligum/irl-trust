  ...
  return (
    <Layout>
      <>
        ...
        <button className='p-2 bg-orange-600'>request to enter the pool</button>
        <h2>share</h2>
        ...
        <div className='flex-row'>
          contribute amount (USDC): <input className='w-32 text-black' type="float" value={0} />+
        ...
        <button className='p-2 bg-orange-600'>send funds</button>
        <div className='flex-row'>
